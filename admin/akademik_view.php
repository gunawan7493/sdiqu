                        ...
                        <a href="index.php?m=admin&p=akademik_form" class="btn btn-success"><i class='glyphicon glyphicon-plus'></i> Tambah</a>
                        <?php
                      ...
                      ?>
                                    <tr>
                                        ...
                                        <td>
            <a href='index.php?m=admin&p=akademik_form&id=<?=$akademik -> id ?>' class="btn btn-info"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp;
